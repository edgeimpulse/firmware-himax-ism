...
/*
 * HM11B1 not support autoi2c now
 */
 ...
 * DP SENCTRL CFG
 */
#define SENCTRL_SENSOR_TYPE					SENSORDPLIB_SENSOR_HM11B1_MSB
...
#define SENCTRL_STREAM_TYPE					SENSORDPLIB_STREAM_HM11B1_LOWPOWER
...
#define SENCTRL_SENSOR_HEIGHT 				400
...
#define DP_HW5X5_OUT_WIDTH 			(DP_INP_OUT_WIDTH)
#define DP_HW5X5_OUT_HEIGHT 		(DP_INP_OUT_HEIGHT)
