...
#define CISDP_INIT_TYPE                 (APP_INIT_TYPE_VIDEO_STREAM) //APP_INIT_TYPE_VIDEO_STREAM or APP_INIT_TYPE_AOS
#define CISDP_SENSORCTRL_MCLK_DIV       (SENSORCTRL_MCLK_DIV1) //dummy
#define CISDP_CIS_XHSUTDOWN_PIN         (AON_GPIO2) //dummy

/*
 * 1-bit parser setting
 */
#define SCLK_UTG				(0) //dummy

/*
* 1-bit parser setting: PACK MODE
* REG_INP_RX_LBUF_INSERT_H_FPORCH = freq(inp_cclk) * sensor_hblank_time / 2
*/
#define RX_LBUF_INSERT_H_FPORCH			(0) //dummy
...
#define DP_INP_CROP_WIDTH          	640
#define DP_INP_CROP_HEIGHT         	480
...
#define DP_WDMA_SIZE_CFG            JPEG_ENC_YUV422_4X
...
#define DP_JPEG_DECCQTABLE 			JPEG_DEC_QTABLE_4X
#endif
