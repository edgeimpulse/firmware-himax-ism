...
#define CISDP_SENSORCTRL_MCLK_DIV       (SENSORCTRL_MCLK_DIV2)
#define CISDP_CIS_XHSUTDOWN_PIN         (CIS_XHSUTDOWN_IOMUX_NONE)
...
/*
 * HM01B0 Bit Depth Option
 */
//#define CIS_IO_1BIT_LSB
#define CIS_IO_4BIT_LSB
//#define CIS_IO_8BIT_LSB
...
#define SENCTRL_SENSOR_TYPE                 SENSORDPLIB_SENSOR_HM01B0_1BITIO_LSB
#elif defined(CIS_IO_4BIT_LSB)
#define SENCTRL_SENSOR_TYPE                 SENSORDPLIB_SENSOR_HM01B0_4BITIO_LSB
#elif defined(CIS_IO_8BIT_LSB)
#define SENCTRL_SENSOR_TYPE                 SENSORDPLIB_SENSOR_HM01B0_8BITIO
#else
#error "not define CIS IO BIT"
#endif

#ifdef CIS_AOS_MODE
#define SENCTRL_STREAM_TYPE					SENSORDPLIB_STREAM_HM01B0_CONT
#else
...
#define SENCTRL_SENSOR_WIDTH 				324
#define SENCTRL_SENSOR_HEIGHT 				244
...
#define DP_INP_OUT_WIDTH 		    324
#define DP_INP_OUT_HEIGHT 		    244
 ...
 * HEIGHT/4
 */
#define DP_HW5X5_PATH				HW5x5_PATH_BYPASS_5X5
...
#define DP_HW5X5_CROP_WIDTH 		DP_INP_OUT_WIDTH
#define DP_HW5X5_CROP_HEIGHT 		DP_INP_OUT_HEIGHT
...
#define DP_JPEG_DEC_WIDTH 			320
#define DP_JPEG_DEC_HEIGHT 			240
